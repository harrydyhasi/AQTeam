...
import 'package:hrm_aqtech/features/time_off_management/controllers/editable_text_field_controller.dart';
...
class GeneralTimeOffDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(EditableTextFieldController(generalTimeOff));
